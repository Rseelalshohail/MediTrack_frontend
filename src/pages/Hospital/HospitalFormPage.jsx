...
import { createHospital, getHospitalById, updateHospital, deleteHospital } from '../../utilities/hospital-api'
...
export default function HospitalFormPage() {
    ...
    const handleDelete = async () => {
        ...
        setLoading(true)
        try {
            await deleteHospital(id, accessToken)
            navigate('/hospitals')
        } catch (err) {
            console.error(err)
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <>
                                            ...
                                            {id ? 'Update Hospital' : 'Create Hospital'}
                                        </>
                                    )}
                                </button>
